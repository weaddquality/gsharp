...
4) Drag the three classes: G#Object.lvclass and IG#.lvclass into the empty library G#.lvlib.
...
WARNING: This will actually change the namespace of the G#Object.lvclass and IG#.lvclass and make all other classes you might have linked created be broken caused by the namespace change. Only do the above action if you really need packed libraries.
